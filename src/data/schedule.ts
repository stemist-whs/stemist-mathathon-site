...
export const schedule: ScheduleItem[] = [
  ...
  { time: "1:30 PM", title: "Power Round", highlight: true, description: "45 minutes — teams of four collaborate on a chained problem set." },
  { time: "2:30 PM", title: "Lunch", description: "Lunch provided for all participants." },
  { time: "3:00 PM", title: "Individual Round", highlight: true, description: "40 minutes — solve independently. Tests your own reasoning and problem solving." },
